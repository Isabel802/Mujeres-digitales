    ...
    xhr.addEventListener("readystatechange", function(resultado) {
        ...
        if(this.readyState === 4) {
            ...
            for (let i = 0; i < convertido.length; i++) {
                ...
                "<tr>"+
                "<th scope='row'>" +
                "<button type='button' class='btn btn-success' style='background-color: cornflowerblue;' data-toggle='modal' data-target='#modalusuario' onclick=CargarId('"+convertido[i]._id+"')>Editar</button></th>"+
